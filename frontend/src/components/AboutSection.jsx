        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <span className="inline-block px-4 py-2 bg-primary/10 rounded-full text-primary text-sm font-medium mb-4">
              About Keetch Elevators
            </span>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              A Decade of <span className="gradient-text">Excellence</span>
            </h2>
            <p className="text-muted-foreground text-lg mb-6">
              Founded in {companyInfo.founded}, Keetch Elevators has grown from a small local 
            ...
            <p className="text-muted-foreground mb-8">
              With over {companyInfo.projectsCompleted} successful projects and a team of 
              {companyInfo.teamMembers}+ certified professionals, we bring expertise and 
