...
const LiveChat = () => {
  ...
  const getBotResponse = (userMessage) => {
    ...
    if (lowerMsg.includes('price') || lowerMsg.includes('cost') || lowerMsg.includes('quote')) {
      return "For a detailed quote, I'd recommend filling out our quote form or calling us at 1-800-KEETCH. Our team will provide a customized estimate based on your specific needs.";
    }
    ...
    if (lowerMsg.includes('emergency') || lowerMsg.includes('urgent')) {
      return "For emergencies, please call our 24/7 hotline at 1-800-KEETCH immediately. Our technicians are available around the clock.";
    }
    ...
    return "Thank you for your message! A member of our team will get back to you shortly. For immediate assistance, call us at 1-800-KEETCH.";
  };
        ...
        <div className="absolute bottom-20 right-0 w-96 max-w-[calc(100vw-3rem)] bg-background rounded-2xl shadow-2xl border border-border overflow-hidden animate-fade-in">
          ...
          <div className="bg-primary p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-primary-foreground font-semibold">Keetch Support</p>
