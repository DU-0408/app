      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
          ...
          <Link to="/contact">
            <Button
              size="lg"
              variant="outline"
              className="px-8 py-6 text-lg rounded-xl border-2 border-background/30 text-background hover:bg-background/10 w-full sm:w-auto"
            >
              Contact Us
            </Button>
          </Link>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-8">
          <a
            ...
            className="flex items-center justify-center gap-3 text-background/70 hover:text-primary transition-colors"
          >
            <div className="w-10 h-10 rounded-xl bg-background/10 flex items-center justify-center">
              <Phone className="w-5 h-5" />
            </div>
            <span className="font-medium">1-800-KEETCH</span>
          </a>
          <a
