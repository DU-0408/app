...
const AboutPage = () => {
  const milestones = [
    { year: '2015', title: 'Company Founded', description: 'Keetch Elevators started with a vision to transform vertical transportation.' },
        ...
        <div className="max-w-7xl mx-auto px-6 mb-20">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Since {companyInfo.founded}, Keetch Elevators has been dedicated to providing 
